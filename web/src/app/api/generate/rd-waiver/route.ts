...
import { RDWaiverGenerator } from '@/lib/generators/rd-waiver-generator';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const generator = new RDWaiverGenerator();
    const result = await generator.generate(
      requestData.client_record,
      '', // doctor parameter not used for RD waiver
    ...
    console.error('RD Accept Waiver generation error:', error);
